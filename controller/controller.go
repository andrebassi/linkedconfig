...
import (
	...
	customConfigMapv1alpha1 "github.com/andrebassi/linkedconfig/pkg/apis/configuratorcontroller/v1alpha1"
	clientset "github.com/andrebassi/linkedconfig/pkg/client/clientset/versioned"
	configscheme "github.com/andrebassi/linkedconfig/pkg/client/clientset/versioned/scheme"
...
const controllerAgentName = "linkedconfig"
...
const (
	...
	MessageResourceExists = "Resource %q already exists and is not managed by LinkedConfig"
	// MessageResourceSynced is the message used for an Event fired when a Configurator
	// is synced successfully
	MessageResourceSynced = "LinkedConfig synced successfully"
)
...
func (c *Controller) handleObject(obj interface{}) {
	...
	if ownerRef := metav1.GetControllerOf(object); ownerRef != nil {
		...
		if ownerRef.Kind != "CustomConfigMap" {
			...
			if err != nil {
				klog.V(4).Infof("ignoring orphaned object '%s' of LinkedConfig '%s'", object.GetSelfLink(), ownerRef.Name)
				return
			}
